...
public class Colosseum {
    ...
    public static Pokemon buildPokemon() {
        ...
        System.out.println("Give your mon a cute or scary name: ");
        tempPokemon.name = myScan.next();
        System.out.println("Determine its bulk: ");
        ...
        System.out.println("Give it a attack value(1 - 49): ");
        ...
        System.out.println("Some say best defense is offense, still your mon needs a defense: (1-" + maxDefense + "): ");
    ...
    public static void determineWinner() {
        if (firstPokemon.hitPoints > secondPokemon.hitPoints) {
            System.out.println(firstPokemon.name + " proves to be victorious!");
        } else if (firstPokemon.hitPoints == secondPokemon.hitPoints){
            System.out.println("It is a tie!");
        } else {
            System.out.println(secondPokemon.name + " proves to be victorious!");
        }
    }
